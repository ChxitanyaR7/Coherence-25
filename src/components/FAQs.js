...
const FAQs = () => {
  ...
  const faqsData = [
    ...
    },
    {
      ...
      answer: "Coherence 25 is being hosted Offline only.",
    },
    {
      question: "What are the eligibility criteria?",
      answer: "The hackathon is open to all participants.",
    },
    {
      ...
      >
        {faqsData.map((faq, index) => (
          <div
            ...
            className={`rounded-3xl p-7 mb-4 border border-blue-700 text-left relative transition-colors duration-300 ${
