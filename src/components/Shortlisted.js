          ...
          <table className="w-full min-w-[300px] rounded-md shadow-lg bg-gray-900 text-white border border-blue-500">
            <thead className="bg-gray-800 border-b border-blue-500">
              <tr className="text-xs sm:text-sm md:text-base">
                <th className="px-2 sm:px-4 py-2 sm:py-3 font-bold border-r border-blue-500 whitespace-nowrap">Team Name</th>
                <th className="px-2 sm:px-4 py-2 sm:py-3 font-bold border-r border-blue-500 whitespace-nowrap">Leader</th>
                <th className="px-2 sm:px-4 py-2 sm:py-3 font-bold border-r border-blue-500 whitespace-nowrap">Domain</th>
                <th className="px-2 sm:px-4 py-2 sm:py-3 font-bold whitespace-nowrap">College</th>
              </tr>
            </thead>
          ...
          <div className="flex flex-wrap justify-center items-center gap-2 mt-6">
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map((pageNumber) => (
              <button
                ...
                className={`px-2 py-1 sm:px-3 sm:py-2 rounded border border-blue-600 transition-colors text-xs sm:text-sm md:text-base ${pageNumber === currentPage ? "bg-blue-600 text-white" : "bg-white text-blue-600"}`}
              >
                {pageNumber}
              </button>
            ))}
